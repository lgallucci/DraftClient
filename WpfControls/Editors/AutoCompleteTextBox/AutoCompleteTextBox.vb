...
#Region "Fields"
    ...
    Public Shared ReadOnly ForegroundColorProperty As DependencyProperty = DependencyProperty.Register("ForegroundColor", GetType(Brush), GetType(AutoCompleteTextBox), New FrameworkPropertyMetadata(Nothing))
